...
const ARTICLES = [
  { title: '제1조 (목적)', body: '본 약관은 PNG 개발팀(이하 "회사")이 제공하는 사진 촬영 명소 및 코스 추천 서비스인 PNG(이하 "서비스")의 이용과 관련하여 회사와 이용자의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.' },
  { title: '제2조 (정의)', body: '1. "서비스"란 회사가 제공하는 사진 촬영 장소 정보, 출사 플래너, 위시리스트, 커뮤니티 기능 등을 의미합니다.\n2. "이용자"란 본 약관에 따라 회사가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.\n3. "게시물"이란 이용자가 서비스에 게시한 사진, 텍스트, 위치 정보 등 일체의 정보를 의미합니다.' },
  ...
  { title: '제5조 (서비스 이용 및 중단)', body: '서비스는 연중무휴 24시간 제공을 원칙으로 하나, 시스템 점검·교체·고장, 통신 장애 등 부득이한 사유가 발생한 경우 서비스 제공이 일시 중단될 수 있습니다.' },
];
    ...
    <SafeAreaView className="flex-1 bg-white" edges={['top', 'left', 'right']}>
      ...
      <View className="border-t-[0.5px] border-hairline" style={{ paddingHorizontal: normalize(20), paddingTop: normalize(12), paddingBottom: normalize(12), borderTopColor: HAIRLINE }}>
        <Pressable onPress={onShare} className="w-full flex-row items-center justify-center border-[1.5px] border-black/10 bg-white" style={{ height: normalize(44), borderRadius: normalize(12) }}>
          ...
          <Text className="font-semibold text-black" style={{ fontSize: FONT_SM, marginLeft: normalize(6) }}>약관 공유</Text>
        </Pressable>
      </View>
    </SafeAreaView>
  );
