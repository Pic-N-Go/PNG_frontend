    ...
    <View className="flex-1 bg-black">
      ...
      >
        ...
        <View className="pt-7" style={{ paddingHorizontal: CONTENT_PADDING }}>
          <Text className="font-medium text-sub mb-2" style={{ fontSize: normalizeFontSize(12) }}>출사 이름</Text>
          <TextInput
        ...
        {/* 날짜 */}
        <View className="pt-7" style={{ paddingHorizontal: CONTENT_PADDING }}>
          <Text className="font-medium text-sub mb-2" style={{ fontSize: normalizeFontSize(12) }}>날짜</Text>
        ...
        {/* 일정 유형 */}
        <View className="pt-7" style={{ paddingHorizontal: CONTENT_PADDING }}>
          <Text className="font-medium text-sub mb-2" style={{ fontSize: normalizeFontSize(12) }}>일정 유형</Text>
