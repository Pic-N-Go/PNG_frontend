...
import { IconEdit, IconFlag, IconTrash } from '@tabler/icons-react-native';
      ...
      <View style={{ paddingHorizontal: GRID_PADDING, paddingBottom: normalize(12) }}>
        {isMine ? (
          ...
          <Pressable
            ...
            accessibilityRole="button"
            accessibilityLabel="리뷰 신고하기"
            style={{ flexDirection: 'row', alignItems: 'center', gap: normalize(12), paddingVertical: normalize(14) }}
          >
            <IconFlag size={normalize(20)} color={BRAND} strokeWidth={2} />
            <Text className="font-normal" allowFontScaling={false} style={{ flex: 1, fontSize: normalizeFontSize(14), color: BRAND, letterSpacing: -0.15 }}>
              신고하기
            </Text>
          </Pressable>
        )}
